    ...
    <el-form :model="formData" :rules="rules" ref="formDataRef" class="post-form" label-width="60px">
        <div class="post-editor">
            ...
            <template #header>
                <div class="header">
                    ...
                    <div class="check" @click="checkEdit">切换为<span v-show="editorType===1">富文本</span><span v-show="editorType===0">markdown</span>编辑器</div>
                </div>
            </template>
        ...
        <div class="post-setting">
            ...
            <el-form-item label="摘要" prop="summary">
                <el-input type="textarea" :rows="5" maxlength="150" :show-word-limit="true" v-model="formData.summary"></el-input>
            </el-form-item>
